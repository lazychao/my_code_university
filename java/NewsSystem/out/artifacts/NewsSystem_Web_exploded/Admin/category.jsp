...
<head>
    ...
    <link rel="stylesheet" href="<%=basePath%>css/pageStyle.css">
...
<div class="goods_list" id="account_List">
    ...
    <ul class="list_goods_ul">
        <li>01</li>
        <li>分类名称</li>
        <li><a href="#"><img class="img_icon" src="<%=basePath%>images/edit_icon.png" alt=""></a></li>
        <li><a href="#"><img class="img_icon" src="<%=basePath%>images/delete_icon.png" alt=""></a></li>
    </ul>
